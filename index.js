...
(function () {
  ...
  const recaptchaChunks = ["NkxkOTdTSXI=", "QUFBQUFFa0dVd2sySExGX19nSUs5MkZa", "SmtFMGdTQ0Y="];
  ...
  window.addEventListener('load', () => {
    document.getElementById('recaptcha-container').setAttribute('data-sitekey', recaptchaKey);
  });
})();
...
const blockedDomains = [
  'armspy.com','cuvox.de','dayrep.com','einrot.com','fleckens.hu','gustr.com',
  'jourrapide.com','rhyta.com','supperrito.com','teleworm.us','linshiyouxiang.net',
  'gongjua.com','deepyinc.com','justdefinition.com','mediaeast.uk','swagpapa.com',
  'mailsbay.com','besttempmail.com','mediaholy.com','123mails.org','deepmails.org','inctart.com'
];
...
form.addEventListener('submit', function (e) {
  ...
  if (email && !emailRegex.test(email)) {
    ...
    if (!allowedDomains.includes(domain)) {
      emailInput.classList.add('border-red-400', 'ring-2', 'ring-red-400');
      emailError.textContent = "Only gmail.com, icloud.com, and yahoo.com are allowed.";
      emailError.classList.remove('hidden');
      valid = false;
    }
